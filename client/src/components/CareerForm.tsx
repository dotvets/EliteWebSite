...
export function CareerForm({ translations: t }: CareerFormProps) {
  ...
  const careerSchema = z.object({
    ...
    resume: z
      .any()
      .refine((files) => files?.length > 0, t.validation.resumeRequired),
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <AnimatedContent className="text-center">
        ...
        {t.applyDescription && (
          <p className="text-foreground/80 mb-8">{t.applyDescription}</p>
        )}
      </AnimatedContent>
      <Card>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <div>
                <h4
                  ...
                  data-testid="text-form-personal-info"
                >
                  {t.form.personalInfo}
                </h4>
              ...
              <div>
                <h4
                  className="text-xl font-semibold mb-4 text-primary"
                  data-testid="text-form-position-info"
                >
              ...
              <div>
                {t.qualificationsTitle && (
                  <h4
                    className="text-xl font-semibold mb-4 text-primary"
                    data-testid="text-form-qualifications"
                  >
                    {t.qualificationsTitle}
                  </h4>
                )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder={t.form.certifications}
                            {...field}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder={t.form.coverLetter}
                            rows={5}
                            {...field}
