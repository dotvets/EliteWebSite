...
export default function ContentWithMediaSection({
  ...
  return (
    <div className={`${className}`}>
      ...
      >
        <div
          className={`grid gap-6 sm:gap-8 md:gap-12 items-center ${hasImage ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1"}`}
        >
          ...
          <motion.div
            ...
            animate={
              isInView
                ? { opacity: 1, x: 0 }
                : { opacity: 0, x: hasImage ? (reverse ? -50 : 50) : 0 }
            }
