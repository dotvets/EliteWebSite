            ...
            >
              ...
              <div className="p-5">
                <h2 className="text-xl font-bold font-heading text-primary mb-2">
                  {(language === "ar" ? p.titleAr : p.titleEn) || p.titleAr}
                </h2>
                <p className="text-foreground/70 text-sm line-clamp-4 whitespace-pre-line">
                  {(
                    (language === "ar" ? p.contentAr : p.contentEn) ||
                    p.contentAr ||
                    ""
                  ).slice(0, 400)}
                </p>
        ...
        const sectionClassName =
          index === 0
            ? className.replace(
                ...
                "pt-20 sm:pt-24 md:pt-28 pb-12 sm:pb-16 md:pb-20",
              )
            : className;
